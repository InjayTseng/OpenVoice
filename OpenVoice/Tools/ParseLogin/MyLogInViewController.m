...
- (void)viewDidLoad {
    ...
    [self.logInView.facebookButton setTitle:@"fb" forState:UIControlStateNormal];
    [self.logInView.facebookButton setTitle:@"fb" forState:UIControlStateHighlighted];
    ...
    [self.logInView.twitterButton setTitle:@"tw" forState:UIControlStateNormal];
    [self.logInView.twitterButton setTitle:@"tw" forState:UIControlStateHighlighted];
